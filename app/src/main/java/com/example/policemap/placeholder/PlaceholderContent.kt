package com.example.policemap.placeholder
...
object PlaceholderContent {
    ...
    private fun createPlaceholderItem(position: Int): User {
        return User(position.toString(), "Item " + position, makeDetails(position))
    }
